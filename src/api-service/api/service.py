...
from inference_engine import (
    InferenceEngine,
)  # Assuming this is your class from the model code

app = FastAPI(
    title="BioViL Model API", description="API for BioViL Model", version="1.0"
)
...
async def predict(request: PredictRequest):
    ...
    try:
        ...
        )  # Assuming the format is "data:image/png;base64,<data>"
